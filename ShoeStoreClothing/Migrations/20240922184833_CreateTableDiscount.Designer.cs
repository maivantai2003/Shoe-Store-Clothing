...
namespace ShoeStoreClothing.Migrations
{
    ...
    [Migration("20240922184833_CreateTableDiscount")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShoeStoreClothing.Models.Blog", b =>
                {
            ...
            modelBuilder.Entity("ShoeStoreClothing.Models.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("UpdateComment")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("ShoeStoreClothing.Models.Discount", b =>
                {
            ...
            modelBuilder.Entity("ShoeStoreClothing.Models.DiscountDetail", b =>
                {
            ...
            modelBuilder.Entity("ShoeStoreClothing.Models.Message", b =>
                {
            ...
            modelBuilder.Entity("ShoeStoreClothing.Models.Notifications", b =>
                {
            ...
            modelBuilder.Entity("ShoeStoreClothing.Models.Replies", b =>
                {
                    ...
                    b.Property<DateTime>("CreateReply")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<DateTime>("UpdateReply")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("ShoeStoreClothing.Models.Discount", b =>
                {
                    b.HasOne("ShoeStoreClothing.Models.Discount", null)
                        .WithMany("Discounts")
            ...
            modelBuilder.Entity("ShoeStoreClothing.Models.DiscountDetail", b =>
                {
                    b.HasOne("ShoeStoreClothing.Models.ProductDetail", "ProductDetail")
                        .WithMany()
                        .HasForeignKey("DiscountDetailId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ShoeStoreClothing.Models.Discount", "Discount")
                        .WithMany()
            ...
            modelBuilder.Entity("ShoeStoreClothing.Models.Replies", b =>
                {
                    b.HasOne("ShoeStoreClothing.Models.Comment", "Comment")
                        .WithMany("replies")
